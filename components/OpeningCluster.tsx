    ...
    >
      ...
      <div className="hero-stage sticky top-0 h-screen overflow-hidden">
        ...
        <div
          ...
          className="pointer-events-none absolute inset-0 z-20 flex flex-col items-center justify-between pt-22 md:pt-24 pb-36 text-center transition-[opacity,transform] duration-700 ease-out md:items-start md:justify-center md:py-0 md:ps-[7vw] md:text-right"
        >
